...
class Servo(object):
   ...
   def __init__(self, directionGPIO, directionMinGauche, directionMaxDroite):
      try:
         ...
         self.pwm = GPIO.PWM(self.directionGPIO, 50)
         self.pwm.start(0)
...
class VoiTuxServer(object):
   def __init__(self):
      try:
         ...
         directionGPIO            = 7   # Servo Number 0 = GPIO 4 = PIN 7
         self.directionMinGauche  = 5  # Valeur min (buté gauche)
         self.directionMaxDroite  = 10 # Valeur max (buté droite)
